from p01sc06_OOPDBGUI3tier import *

from decimal import Decimal, ROUND_HALF_UP
import locale as lc

from p01sc06_OOPDBGUI3tier.p01beg_1da_sales import DataFileAccess, SalesList, Sales, InputAccess, SalesFile, \
    ImportedFile, Regions
    ...
    def view_sales(sales_list: SalesList) -> bool:
        ...
        if sales_list.count == 0:
            ...
            for idx in range(1, sales_list.count+1):
                ...
                region = sales.region.name if sales.region else "Unknown Region"
