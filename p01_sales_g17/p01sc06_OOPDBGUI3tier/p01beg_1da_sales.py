...
class DataFileAccess:
    ...
    def save_all_sales(self, delimiter: str = ',', writer=None) -> None:
        ...
        sales_records = [
            [sales.amount, sales.sales_date.strftime(Sales.DATE_FORMAT) if isinstance(sales.sales_date, date) else "?",
             sales.region.code]
